      ...
      <div className="container mx-auto px-4 md:px-6 lg:px-8">
        <div className="text-center text-slate-500 dark:text-slate-400 text-xs space-y-2">
            <div className="flex items-center justify-center gap-1 text-sm">
              ...
              {/* Simple Text Logo in Footer with Kaushan Script (Avallon style) - Lowercase */}
              <span className="font-script text-3xl text-slate-700 dark:text-slate-300">muse</span>
              <span>. All Rights Reserved.</span>
            </div>
            <p>
              Developed by <strong>Syed Mohammed Idris</strong>. Tested by <strong>saleemuddin(PCMB)</strong> Falcon Institute Mysore Road Branch. | <button onClick={() => setIsModalOpen(true)} className="font-semibold text-blue-600 dark:text-blue-400 hover:underline">Share Feedback</button>
            </p>
        </div>
      </div>
      <FeedbackModal 
